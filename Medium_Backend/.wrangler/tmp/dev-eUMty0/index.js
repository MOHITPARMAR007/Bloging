...
// C:/Users/Asus/AppData/Roaming/npm/node_modules/wrangler/templates/modules-watch-stub.js
  ...
  "node_modules/@prisma/client/runtime/edge.js"(exports, module) {
    ...
    C.cubeRoot = C.cbrt = function() {
      ...
      if (!g.isFinite() || g.isZero())
        return new h(g);
      for (N = false, o = g.s * W(g.s * g, 1 / 3), !o || Math.abs(o) == 1 / 0 ? (r = z2(g.d), e = g.e, (o = (e - r.length + 1) % 3) && (r += o == 1 || o == -2 ? "0" : "00"), o = W(r, 1 / 3), e = X((e + 1) / 3) - (e % 3 == (e < 0 ? -1 : 2)), o == 1 / 0 ? r = "5e" + e : (r = o.toExponential(), r = r.slice(0, r.indexOf("e") + 1) + e), n = new h(r), n.s = g.s) : n = new h(o.toString()), s = (e = h.precision) + 3; ; )
        if (a = n, l = a.times(a).times(a), f = l.plus(g), n = $(f.plus(g).times(a), f.plus(l), s + 2, 1), z2(a.d).slice(0, s) === (r = z2(n.d)).slice(0, s))
      ...
      if (N = false, a = h + S, s = ke(f, a), n = t ? br(g, a + 10) : ke(e, a), l = $(s, n, a, 1), kt(l.d, i = h, v))
        do
          if (a += 10, s = ke(f, a), n = t ? br(g, a + 10) : ke(e, a), l = $(s, n, a, 1), !o) {
            +z2(l.d).slice(i + 1, i + 15) + 1 == 1e14 && (l = I(l, h + 1, 0));
            break;
          }
        while (kt(l.d, i += 10, v));
    ...
    C.squareRoot = C.sqrt = function() {
      ...
      for (N = false, f = Math.sqrt(+s), f == 0 || f == 1 / 0 ? (t = z2(a), (t.length + l) % 2 == 0 && (t += "0"), f = Math.sqrt(t), l = X((l + 1) / 2) - (l < 0 || l % 2), f == 1 / 0 ? t = "5e" + l : (t = f.toExponential(), t = t.slice(0, t.indexOf("e") + 1) + l), n = new g(t)) : n = new g(f.toString()), r = (l = g.precision) + 3; ; )
        if (o = n, n = o.plus($(s, o, r + 2, 1)).times(0.5), z2(o.d).slice(0, r) === (t = z2(n.d)).slice(0, r))
    ...
    C.toFraction = function(e) {
      ...
      for (N = false, a = new A(z2(R)), g = A.precision, A.precision = o = R.length * k * 2; h = $(a, t, 0, 1, 1), i = r.plus(h.times(n)), i.cmp(e) != 1; )
    ...
    C.toPower = C.pow = function(e) {
      ...
      return r = W(+a, f), t = r == 0 || !isFinite(r) ? X(f * (Math.log("0." + z2(a.d)) / Math.LN10 + a.e + 1)) : new l(r + "").e, t > l.maxE + 1 || t < l.minE - 1 ? new l(t > 0 ? s / 0 : 0) : (N = false, l.rounding = a.s = 1, r = Math.min(12, (t + "").length), i = In(e.times(ke(a, n + r)), n), i.d && (i = I(i, n + 5, 1), kt(i.d, n, o) && (t = n + 10, i = I(In(e.times(ke(a, t + r)), t), t + 5, 1), +z2(i.d).slice(n + 1, n + 15) + 1 == 1e14 && (i = I(i, n + 1, 0)))), i.s = s, N = true, l.rounding = o, I(i, n, o));
    };
    ...
    function ge(e, t, r) {
      if (!e.isFinite())
        return Eo(e);
      var n, i = e.e, o = z2(e.d), s = o.length;
    ...
    function In(e, t) {
      ...
      for (n = Math.log(W(2, h)) / Math.LN10 * 2 + 5 | 0, l += n, r = o = s = new v(1), v.precision = l; ; ) {
        if (o = I(o.times(e), l, 1), r = r.times(++g), a = s.plus($(o, r, l, 1)), z2(a.d).slice(0, l) === z2(s.d).slice(0, l)) {
          for (i = h; i--; )
            s = I(s.times(s), l, 1);
          if (t == null)
    ...
    function ke(e, t) {
      ...
      if (t == null ? (N = false, g = O) : g = t, M.precision = g += R, r = z2(D), n = r.charAt(0), Math.abs(o = A.e) < 15e14) {
        for (; n < 7 && n != 1 || n == 1 && r.charAt(1) > 3; )
          A = A.times(e), r = z2(A.d), n = r.charAt(0), S++;
      ...
      for (h = A, l = s = A = $(A.minus(1), A.plus(1), g, 1), v = I(A.times(A), g, 1), i = 3; ; ) {
        if (s = I(s.times(v), g, 1), f = l.plus($(s, new M(i), g, 1)), z2(f.d).slice(0, g) === z2(l.d).slice(0, g))
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\Asus\\Desktop\\Bloging\\Medium_Backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\Asus\\Desktop\\Bloging\\Medium_Backend\\prisma\\schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// .wrangler/tmp/bundle-1PLuAS/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-1PLuAS/middleware-insertion-facade.js
init_modules_watch_stub();
...
blogRouter.use("/*", async (c, next) => {
  try {
    ...
    const response = await verify2(authHeader, c.env.JWT_SECRET);
    if (response) {
