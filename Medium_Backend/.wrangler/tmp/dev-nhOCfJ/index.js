...
// .wrangler/tmp/bundle-8qjyvY/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-8qjyvY/middleware-insertion-facade.js
init_modules_watch_stub();
...
blogRouter.get("/:id", async (c) => {
  ...
  try {
    const blogblog = await prisma.post.findUnique({
      where: { id }
    });
    return c.json({
      blog
